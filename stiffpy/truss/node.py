...
class Node(Node1):
    ...
    def restrains(self, restrain: Tuple[bool, bool]):
        self._restrains = np.array([restrain[0], restrain[1], False, False, False, False])

    @elastic_constants.setter
    def elastic_constants(self, elastic_constant: list):
        self._elastic_constants = np.array([elastic_constant[0], elastic_constant[1], False, False, False, False])

    @displacements.setter
    def displacements(self, displacement: list):
        self._displacements = np.array([displacement[0], displacement[1], 0, 0, 0, 0])
